...
<a href="#" id="endbutton" class="button">结束</a> \
...
MOEBATTLEUI.load = function () {
	...
	$("#" + MOEPROJ.config.canvas + " #anime img").error(function () {
